...
enum CoinType
{
    ...
    COIN_FLAG_SEED_PACKET,
    COIN_PERMA_FLAG_SEED_PACKET
};
enum CrazyDaveState
{
    CRAZY_DAVE_OFF = 0,
...
enum Dialogs
{
    ...
    DIALOG_ARCHIPELAGO_STATUS,
    DIALOG_ARCHIPELAGO_CONNECTING,
    DIALOG_ARCHIPELAGO_UNCOMPLETABLE,
    DIALOG_NEWNEWOPTIONS,
    DIALOG_APOPTIONS,
    NUM_DIALOGS
};
enum DebugTextMode
...
enum MessageStyle
{
    ...
    MESSAGE_STYLE_ARCHIPELAGO_UPDATE,
    MESSAGE_STYLE_ARCHIPELAGO_COUNTDOWN
};
enum MowerHeight
{
    MOWER_HEIGHT_LAND = 0,
